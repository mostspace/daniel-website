    ...
    <div className="row container about_section">
      <div className="columns" data-aos="fade-right" data-aos-delay="300">
        ...
        <h4>
          <FormattedMessage
            id="descriptions"
            defaultMessage="Hello! I'm Daniel,"
          />
        </h4>
        <p>I am a passionate senior full stack engineer with over 10 years of experience in software engineering.</p>
        <p> Always love challenges and hard working to achieve goals. Have advanced knowledge of multiple programming languages, frameworks and extensive familiarity with several database structures.</p>
        ...
        <p>Working as a senior developer, lead developer, I have built several successful websites, mobile apps, and DeFi platforms for a large number of users, and have successfully completed several projects involving various technical fields depending on the business idea of the client.</p>
