...
export const DISCORD_ADDRESS = 'https://discord.gg/jkD7nDyDQC';
export const SLACK_ADDRESS = 'https://join.slack.com/t/danielsworksp-rhq1949/shared_invite/zt-25ythaztd-qka1KoDvdxBwhPJAOhxrHQ';
...
export const WHO_I_AM_CONTENT = [
    "Over the past 10 years, I have worked as a Full Stack developer in the field of Web/Mobile Application development.",
...
export const WHAT_I_DO = [
    {
        ...
        content: 'Creation of well-structured web pages, good responsive design, attractive color palette, with interactions that give the user satisfaction when browsing the website.',
        icon: 'fas fa-laptop'
    },{
        header: 'Mobile App Development',
        content: 'With my expertise in Mobile/Desktop app development, we can build high-performance mobile/desktop applications tailored specifically to Android/iOS and Windows/Linux/MacOS. Your app will leverage the full potential of the operating system, resulting in optimal performance and reliability.',
        icon: 'fas fa-mobile-alt'
    },{
        header: 'DESIGN',
        content: 'Creating amazing designs that engage users and reflect your brand’s essence. Transforming ideas into visually stunning and user-friendly designs. Let’s bring your online presence to life!',
        icon: 'fas fa-drafting-compass'
    },{
        header: 'WEB MARKETING',
        content: 'Professional web development services tailored to your needs. We create visually stunning and user-friendly websites, optimizing performance and ensuring seamless functionality. ',
        icon: 'fas fa-chart-line'
    },{
        header: 'SECURITY',
        content: 'Transform your ideas into innovative mobile applications. Our app development services deliver intuitive and feature-rich solutions across platforms, engaging users and driving business growth.',
